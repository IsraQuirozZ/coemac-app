...
export const reunionesStyles = StyleSheet.create({
  ...
  // ── CARD exterior ──
  card: { backgroundColor: colors.card, borderRadius: 16, borderWidth: 1, borderColor: "#E2E2E2", flexDirection: "row", alignItems: "center", paddingVertical: 14, paddingHorizontal: 14, shadowColor: "#000", shadowOpacity: 0.04, shadowOffset: { width: 0, height: 1 }, shadowRadius: 4, elevation: 1, gap: 12 },

  // ── Columna fecha (dos bloques apilados) ──
  cardDateCol: { width: 56, flexShrink: 0, gap: 4 },
  cardDateTop: { backgroundColor: "#C8DDD6", borderRadius: 10, alignItems: "center", justifyContent: "center", paddingVertical: 7, paddingHorizontal: 4 },
  cardDay: { fontSize: 20, fontWeight: "800", color: colors.primary, lineHeight: 24, letterSpacing: -0.3 },
  cardMonth: { fontSize: 12, fontWeight: "600", color: colors.primary, lineHeight: 15 },
  cardDateBottom: { backgroundColor: "#EDF4F1", borderRadius: 8, alignItems: "center", justifyContent: "center", paddingVertical: 4, paddingHorizontal: 4 },
  cardHourSmall: { fontSize: 11.5, fontWeight: "500", color: "#8AADA3" },

  // ── Avatar + info ──
  cardAvatar: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.border, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  cardInfo: { flex: 1, gap: 2 },
  cardHour: { fontSize: 13, fontWeight: "600", color: colors.primaryText, lineHeight: 18 },
  ...
  cardDesc: { fontSize: 12.5, fontWeight: "400", color: colors.secondaryText, lineHeight: 17 },
