...
export const informeStyles = StyleSheet.create({
  ...
  itemCard:      { backgroundColor: "#fff", borderRadius: 12, borderWidth: 1, borderColor: "#E2E2E2", padding: 14, gap: 6 },
  row:           { flexDirection: "row", justifyContent: "space-between", gap: 8 },
  rowLabel:      { fontSize: 13, color: colors.secondaryText, flex: 1 },
  rowValue:      { fontSize: 13, color: colors.primaryText, fontWeight: "500", flex: 2, textAlign: "right" },
